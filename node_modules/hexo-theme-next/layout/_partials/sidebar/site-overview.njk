<div class="site-author animated" itemprop="author" itemscope itemtype="http://schema.org/Person">
  {%- if theme.avatar.url %}
  <a href="{{ config.root }}" rel="start" style="display: inline-block; border: none; border-radius: 50%;">
    <img class="site-author-image" itemprop="image" alt="{{ author }}" src="{{ url_for(theme.avatar.url) }}">
  </a>
  {%- endif %}
